...
<!-- Mirrored from wp.alithemes.com/html/frox/demos/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Jun 2025 06:48:49 GMT -->
...
<head>
  ...
  <link rel="icon" href="./assets/admin/assets/images/icons/icon-favicon.svg" type="image/x-icon" sizes="16x16">
  <link rel="stylesheet" href="./assets/admin/assets/styles/tailwind.minf731.css?v=5.0">
  <link rel="stylesheet" href="./assets/admin/assets/styles/style.minf731.css?v=5.0">
...
<body class="w-screen relative overflow-x-hidden min-h-screen bg-gray-100 scrollbar-hide authentication-sign-in-page dark:bg-[#000]">
  <div class="wrapper mx-auto text-gray-900 font-normal grid scrollbar-hide grid-cols-[257px,1fr] grid-rows-[auto,1fr]" id="layout">
    ...
    <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
      <div>
        ...
        <?php endif; ?>
        <form class="rounded-2xl bg-white mx-auto p-10 text-center max-w-[440px] my-[84px] dark:bg-[#1F2128]" action="?admin=login" method="POST">
          <div class="mb-4 text-center mx-auto"><img class="inline-block" src="./assets/admin/assets/images/icons/icon-landing-success-1.svg" alt="landing success"></div>
          <h3 class="font-bold text-2xl text-gray-1100 capitalize mb-[5px] dark:text-gray-dark-1100">Chào mừng!</h3>
          <p class="text-sm text-gray-500 mb-[30px] dark:text-gray-dark-500">Mừng bạn quay trở lại!</p>
          <div>
            <label for="email">
            ...
            <div class="form-control mb-[20px]">
              <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="email" placeholder="Email" name="email">
                <button class="btn-square flex items-center justify-center bg-transparent"><img src="./assets/admin/assets/images/icons/icon-sms.svg" alt="sms icon"></button>
              </div>
            </div>
            <label for="psw">
            ...
            <div class="form-control mb-[20px]">
              <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="password" placeholder="Password" name="password_hash" autocomplete="on">
                <button class="btn-square border-white flex items-center justify-center bg-transparent"><img src="./assets/admin/assets/images/icons/icon-eye.svg" alt="eye icon"></button>
              </div>
            </div>
          </div>
          <button type="submit" class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 w-full border-neutral-bg mb-[20px] py-[14px] dark:border-dark-neutral-bg">Login</button>
            ...
            <div class="flex items-end justify-between mb-[76px]">
              <div class="flex items-start gap-x-[10px]">
                ...
                <div class="flex flex-col gap-y-2">
                  ...
                  <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">E-mail: <a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="acd8c5c182c6c9c2c2c5c2cbdfecc9d4cdc1dcc0c982cfc3c1">[email&#160;protected]</a></p>
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-2.png" alt="user avatar"></a>
                      <div>
                        ...
                        <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1c7e7572747d722a2e245c7b717d7570327f7371">[email&#160;protected]</a></p>
                      </div>
                    </div>
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-3.png" alt="user avatar"></a>
                      <div>
                        ...
                        <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6713151209000c0e020914170c1309032700060a060e0b4904080a">[email&#160;protected]</a></p>
                      </div>
                    </div>
                    <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                      <option>Can Edit</option>
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-4.png" alt="user avatar"></a>
                      <div>
                        ...
                        <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="761b17181e1e17151e1d02464e36111b171f1a5815191b">[email&#160;protected]</a></p>
                      </div>
                    </div>
                    <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                      <option>Can Edit</option>
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-5.png" alt="user avatar"></a>
                      <div>
                        ...
                        <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="26524f43484a475655564d52484266414b474f4a0845494b">[email&#160;protected]</a></p>
                      </div>
                    </div>
                    <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                      <option>Can Edit</option>
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-1.png" alt="user avatar"></a>
                      <div>
                        ...
                        <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fa8e889b948e928f83d4948f8e9fba9d979b9396d4999597">[email&#160;protected]</a></p>
                      </div>
                    </div>
                    <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                      <option>Can Edit</option>
  ...
  <script src="assets/scripts/appf731.js?v=5.0"></script>
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"9539c8ad98e88550","version":"2025.6.2","r":1,"serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3aa9a3481f734e94bceb8bb1bd648ba1","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from wp.alithemes.com/html/frox/demos/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Jun 2025 06:48:50 GMT -->
