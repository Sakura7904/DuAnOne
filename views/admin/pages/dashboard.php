    ...
    <div class="grid grid-cols-1 gap-6 mb-[26px] lg:grid-cols-2 xl:grid-cols-4">
        <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg py-4 flex-1 px-[19px]">
            ...
            <div class="flex items-center justify-between mb-[2px]">
                ...
                <div class="flex items-center gap-[7px]"><img src="./assets/admin/assets/images/icons/icon-export-green.svg" alt=""><span class="text-green text-subtitle font-medium">34.7%</span></div>
            </div>
        ...
        <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg py-4 flex-1 px-[19px]">
            ...
            <div class="flex items-center justify-between mb-[2px]">
                ...
                <div class="flex items-center gap-[7px]"><img src="./assets/admin/assets/images/icons/icon-export-green.svg" alt=""><span class="text-green text-subtitle font-medium">22.8%</span></div>
            </div>
            <p class="text-right text-gray-400 dark:text-gray-dark-400 text-[11px] leading-[16px]">Compared to Jan 2022</p>
        </div>
        <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg py-4 flex-1 px-[19px]">
            ...
            <div class="flex items-center justify-between mb-[2px]">
                ...
                <div class="flex items-center gap-[7px]"><img src="./assets/admin/assets/images/icons/icon-export-green.svg" alt=""><span class="text-green text-subtitle font-medium">17.8%</span></div>
            </div>
            <p class="text-right text-gray-400 dark:text-gray-dark-400 text-[11px] leading-[16px]">Compared to Jan 2022</p>
        </div>
        <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg py-4 flex-1 px-[19px]">
            ...
            <div class="flex items-center justify-between mb-[2px]">
                ...
                <div class="flex items-center gap-[7px]"><img src="./assets/admin/assets/images/icons/icon-export-green.svg" alt=""><span class="text-green text-subtitle font-medium">23.9%</span></div>
            </div>
            <p class="text-right text-gray-400 dark:text-gray-dark-400 text-[11px] leading-[16px]">Compared to Jan 2022</p>
        </div>
    </div>
            ...
            <div class="pt-5 flex flex-col gap-5 px-[26px] pb-[22px]">
                <div class="flex items-center justify-between">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-lg"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/seller-avatar-1.png" alt="seller avatar"></div>
                        <div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-lg"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/seller-avatar-2.png" alt="seller avatar"></div>
                        <div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-lg"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/seller-avatar-3.png" alt="seller avatar"></div>
                        <div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-lg"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/seller-avatar-4.png" alt="seller avatar"></div>
                        <div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-lg"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/seller-avatar-5.png" alt="seller avatar"></div>
                        <div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-lg"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/seller-avatar-6.png" alt="seller avatar"></div>
                        <div>
        ...
        <table class="w-full min-w-[900px]">
            ...
            <tbody>
                <tr class="border-b text-normal text-gray-1100 border-neutral dark:border-dark-neutral-border dark:text-gray-dark-1100">
                    ...
                    <td>
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 rounded-full overflow-hidden"><img src="./assets/admin/assets/images/seller-avatar-1.png" alt="user avatar"></div>
                ...
                <tr class="border-b text-normal text-gray-1100 border-neutral dark:border-dark-neutral-border dark:text-gray-dark-1100">
                    ...
                    <td>
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 rounded-full overflow-hidden"><img src="./assets/admin/assets/images/seller-avatar-4.png" alt="user avatar"></div>
                ...
                <tr class="border-b text-normal text-gray-1100 border-neutral dark:border-dark-neutral-border dark:text-gray-dark-1100">
                    ...
                    <td>
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 rounded-full overflow-hidden"><img src="./assets/admin/assets/images/seller-avatar-5.png" alt="user avatar"></div>
                ...
                <tr class="border-b text-normal text-gray-1100 border-neutral dark:border-dark-neutral-border dark:text-gray-dark-1100">
                    ...
                    <td>
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 rounded-full overflow-hidden"><img src="./assets/admin/assets/images/seller-avatar-6.png" alt="user avatar"></div>
            ...
            <div class="flex items-end justify-between mb-[76px]">
                <div class="flex items-start gap-x-[10px]">
                    ...
                    <div class="flex flex-col gap-y-2">
                        ...
                        <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">E-mail: <a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0c786561226669626265626b7f4c69746d617c6069226f6361">[email&#160;protected]</a></p>
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-2.png" alt="user avatar"></a>
                                <div>
                                    ...
                                    <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b8dad1d6d0d9d68e8a80f8dfd5d9d1d496dbd7d5">[email&#160;protected]</a></p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-3.png" alt="user avatar"></a>
                                <div>
                                    ...
                                    <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7d090f08131a161418130e0d160913193d1a1c101c1411531e1210">[email&#160;protected]</a></p>
                                </div>
                            </div>
                            <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                                <option>Can Edit</option>
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-4.png" alt="user avatar"></a>
                                <div>
                                    ...
                                    <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2449454a4c4c45474c4f50141c644349454d480a474b49">[email&#160;protected]</a></p>
                                </div>
                            </div>
                            <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                                <option>Can Edit</option>
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-5.png" alt="user avatar"></a>
                                <div>
                                    ...
                                    <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="691d000c070508191a19021d070d290e04080005470a0604">[email&#160;protected]</a></p>
                                </div>
                            </div>
                            <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                                <option>Can Edit</option>
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-1.png" alt="user avatar"></a>
                                <div>
                                    ...
                                    <p class="text-desc text-gray-400 dark:text-gray-dark-400"><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0f7b7d6e617b677a7621617a7b6a4f68626e6663216c6062">[email&#160;protected]</a></p>
                                </div>
                            </div>
                            <select class="select text-gray-500 pl-1 font-normal h-fit min-h-fit dark:text-gray-dark-500 focus:outline-0 select-caret">
                                <option>Can Edit</option>
