...
<div><a class="mb-10" href="index.html"> <img class="logo-maximize" src="./assets/admin/assets/images/icons/icon-logo.svg" alt="Frox logo"><img class="logo-minimize ml-[10px]" src="./assets/admin/assets/images/icons/icon-favicon.svg" alt="Frox logo"></a>
    <div class="pt-[106px] lg:pt-[35px] pb-[18px]">
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent active" for="dashboard">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-favorite-chart.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Dashboard</span></div>
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="finance">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-wallet.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Photo gallery</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
                    <li class="pb-2 transition-opacity duration-150 hover:opacity-75"><a class="text-normal" href="index.php?act=product_images">List Photo gallery</a></li>
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="cms">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-cms.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">CMS</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="crm">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-crm.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">CRM</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="analytics">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-analytics.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Analytics</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="project-manage">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-project.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Project Manage</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="chat">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-chat.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Chat / Message</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="network">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-network.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Social Network</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="crypto">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-crypto.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Crypto</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="mailbox">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-mailbox.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Mailbox</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="course">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-course.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Online Course</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="file">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-file.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">File Manager</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
        ...
        <div class="sidemenu-item rounded-xl relative">
            ...
            <label class="flex items-center justify-between w-full cursor-pointer py-[17px] px-[21px] focus:outline-none peer-checked:border-transparent" for="help">
                <div class="flex items-center gap-[10px]"><img src="./assets/admin/assets/images/icons/icon-headphone.svg" alt="side menu icon"><span class="text-normal font-semibold text-gray-500 sidemenu-title dark:text-gray-dark-500">Help Center</span></div>
            </label><img class="absolute right-2 transition-all duration-150 caret-icon pointer-events-none peer-checked:rotate-180 top-[22px]" src="./assets/admin/assets/images/icons/icon-arrow-down.svg" alt="caret icon">
            <div class="hidden peer-checked:block">
                <ul class="text-gray-300 child-menu z-10 pl-[53px]">
    ...
    <div class="category-list">
        ...
        <div><a class="flex items-center justify-between py-3 pl-6" href="#"><span class="text-gray-500 text-normal dark:text-gray-dark-500">Laptops</span>
            ...
            </a><a class="flex items-center justify-between py-3 pl-6" href="#"><span class="text-gray-500 text-normal dark:text-gray-dark-500">Mobile phones</span>
            ...
            </a><a class="flex items-center justify-between py-3 pl-6" href="#"><span class="text-gray-500 text-normal dark:text-gray-dark-500">Desktops</span></a><a class="flex items-center justify-between py-3 pl-6" href="#"><span class="text-gray-500 text-normal dark:text-gray-dark-500">Accessories</span>
            ...
            </a><a class="flex items-center justify-between py-3 pl-6" href="#"><span class="text-gray-500 text-normal dark:text-gray-dark-500">Portable storage</span>
            ...
            </a><a class="flex items-center justify-between py-3 pl-6" href="#"><span class="text-gray-500 text-normal dark:text-gray-dark-500">Networking</span></a>
        </div>
        <div class="flex items-center gap-3 py-3 px-6 mb-[22px]"><img src="./assets/admin/assets/images/icons/icon-add-square.svg" alt="add icon">
    ...
    <div class="pl-6 seller-maximize mb-[35px]">
        ...
        <div class="flex items-center"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-50" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-1.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-40 translate-x-[-10px]" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-2.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-30 translate-x-[-20px]" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-3.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-20 translate-x-[-30px]" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-4.png" alt="user avatar"></a>
            <button class="w-9 h-9 rounded-full border-neutral overflow-hidden bg-color-brands grid place-items-center border-[1.4px] dark:border-dark-neutral-border z-10 translate-x-[-40px]" type="button"><img src="./assets/admin/assets/images/icons/icon-add-circle.svg" alt="plus icon"></button>
        </div>
    </div>
    <div class="seller-minimize">
        <h3 class="text-sm font-bold text-gray-1100 mb-[15px] dark:text-gray-dark-1100">Sellers</h3>
        <div class="flex items-center round text-"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-50" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-1.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-40 translate-x-[-10px]" href="seller-details.html"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/avatar-layouts-2.png" alt="user avatar"></a>
        </div>
    </div>
    <div class="upgrade-card">
        <div class="w-full bg-neutral h-[1px] mb-[35px] dark:bg-dark-neutral-border"></div>
        <div class="rounded-xl bg-neutral py-5 w-fit flex flex-col gap-5 justify-between px-[31px] dark:bg-dark-neutral-border">
            <div class="relative mr-[18px]"><img class="ml-[6px] dark:hidden" src="./assets/admin/assets/images/icons/icon-chat-bubble.svg" alt="chat bubble"><img class="hidden ml-[6px] dark:block" src="./assets/admin/assets/images/icons/icon-chat-bubble-dark.svg" alt="chat bubble"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/hero-layouts.svg" alt="hero"><img class="ml-auto absolute right-0 translate-x-[120%]" src="./assets/admin/assets/images/circle-list-1.png" alt="circle list"></div>
...
<div class="rounded-xl bg-neutral pt-4 flex items-center gap-5 mt-5 sidebar-control pr-[18px] pb-[13px] pl-[19px] dark:bg-dark-neutral-border">
    <div class="flex items-center gap-3"><i class="moon-icon" id="theme-toggle-dark-icon"><img class="cursor-pointer" src="./assets/admin/assets/images/icons/icon-moon.svg" alt="moon icon"><img class="cursor-pointer" src="./assets/admin/assets/images/icons/icon-moon-active.svg" alt="moon icon"></i>
        ...
        </label><i class="sun-icon" id="theme-toggle-light-icon"><img class="cursor-pointer" src="./assets/admin/assets/images/icons/icon-sun.svg" alt="sun icon"><img class="cursor-pointer" src="./assets/admin/assets/images/icons/icon-sun-active.svg" alt="sun icon"></i>
    </div>
    <div class="bg-neutral-bg w-[2px] h-[30px] dark:bg-dark-neutral-bg"></div>
    <div> <img class="cursor-pointer" id="sidebar-expand" src="./assets/admin/assets/images/icons/icon-maximize-3.svg" alt="expand icon"></div>
</div>