...
<div class="flex items-center order-2 user-noti gap-[30px] xl:gap-[48px] lg:order-3 lg:mr-0">
    <div class="dropdown dropdown-end">
        <label class="cursor-pointer dropdown-label" tabindex="0">
            <div class="relative w-[26px] h-[26px]"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/icons/icon-messages.svg" alt="message icon">
        ...
        <ul class="dropdown-content" tabindex="0">
            <div class="relative menu rounded-box dropdown-shadow bg-white px-6 mt-[50px] min-w-[350px] pt-[21px] pb-[11px] dark:bg-dark-neutral-bg">
                ...
                <li class="rounded ml-[-14px] hover:bg-gray-100 w-[calc(100%+28px)] dark:hover:bg-gray-dark-100">
                    <div class="flex items-start bg-transparent gap-[10px] p-[14px]"><img class="w-8 h-8 rounded-full" src="./assets/admin/assets/images/avatar-layouts-1.png" alt="user avatar">
                        <div>
                ...
                <li class="rounded ml-[-14px] hover:bg-gray-100 w-[calc(100%+28px)] dark:hover:bg-gray-dark-100">
                    <div class="flex items-start bg-transparent gap-[10px] p-[14px]"><img class="w-8 h-8 rounded-full" src="./assets/admin/assets/images/avatar-layouts-2.png" alt="user avatar">
                        <div>
                            <div class="flex items-center gap-[25px] mb-[7px]">
                ...
                <div class="w-full bg-neutral h-[1px] dark:bg-dark-neutral-border"></div>
                <li class="rounded ml-[-14px] hover:bg-gray-100 w-[calc(100%+28px)] dark:hover:bg-gray-dark-100">
                    <div class="flex items-start bg-transparent gap-[10px] p-[14px]"><img class="w-8 h-8 rounded-full" src="./assets/admin/assets/images/avatar-layouts-3.png" alt="user avatar">
                        <div>
                            <div class="flex items-center gap-[25px] mb-[7px]">
    ...
    <div class="dropdown dropdown-end">
        <label class="cursor-pointer dropdown-label" tabindex="0">
            <div class="relative w-[26px] h-[26px]"><img class="w-full h-full object-cover" src="./assets/admin/assets/images/icons/icon-notification-bing.svg" alt="notification icon">
                <div class="w-2 h-2 bg-fuchsia rounded-full absolute right-[1px] top-[-1px]"></div>
            </div>
        </label>
        <ul class="dropdown-content" tabindex="0">
            <div class="relative menu rounded-box dropdown-shadow bg-white px-6 mt-[50px] min-w-[350px] pt-[21px] pb-[11px] dark:bg-dark-neutral-bg">
                ...
                <li class="rounded ml-[-14px] hover:bg-gray-100 w-[calc(100%+28px)] dark:hover:bg-gray-dark-100">
                    <div class="flex items-start bg-transparent gap-[10px] p-[14px]"><img class="w-8 h-8 rounded-full" src="./assets/admin/assets/images/avatar-layouts-4.png" alt="user avatar">
                        <div>
    ...
    <div class="dropdown dropdown-end">
        <label class="cursor-pointer dropdown-label" tabindex="0"><img src="./assets/admin/assets/images/avatar-layouts-5.png" alt="user avatar">
        </label>
        <ul class="dropdown-content" tabindex="0">
            <div class="relative menu rounded-box dropdown-shadow p-[25px] pb-[10px] bg-neutral-bg mt-[25px] md:mt-[40px] min-w-[237px] dark:text-gray-dark-500 dark:border-dark-neutral-border dark:bg-dark-neutral-bg">
                ...
                <li class="text-gray-500 hover:text-gray-1100 hover:bg-gray-100 dark:text-gray-dark-500 dark:hover:text-gray-dark-1100 dark:hover:bg-gray-dark-100 rounded-lg group p-[15px] pl-[21px]"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="sign-in.html"> <i class="w-4 h-4 grid place-items-center"><img class="group-hover:filter-black dark:group-hover:filter-white" src="./assets/admin/assets/images/icons/icon-user.svg" alt="icon"></i><span>Profile</span></a>
                </li>
                <li class="text-gray-500 hover:text-gray-1100 hover:bg-gray-100 dark:text-gray-dark-500 dark:hover:text-gray-dark-1100 dark:hover:bg-gray-dark-100 rounded-lg group p-[15px] pl-[21px]"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img class="group-hover:filter-black dark:group-hover:filter-white" src="./assets/admin/assets/images/icons/icon-favorite-chart.svg" alt="icon"></i><span>Dashboard</span></a>
                </li>
                <li class="text-gray-500 hover:text-gray-1100 hover:bg-gray-100 dark:text-gray-dark-500 dark:hover:text-gray-dark-1100 dark:hover:bg-gray-dark-100 rounded-lg group p-[15px] pl-[21px]"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img class="group-hover:filter-black dark:group-hover:filter-white" src="./assets/admin/assets/images/icons/icon-bitcoin-card.svg" alt="icon"></i><span>Payouts</span></a>
                </li>
                <li class="text-gray-500 hover:text-gray-1100 hover:bg-gray-100 dark:text-gray-dark-500 dark:hover:text-gray-dark-1100 dark:hover:bg-gray-dark-100 rounded-lg group p-[15px] pl-[21px]"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img class="group-hover:filter-black dark:group-hover:filter-white" src="./assets/admin/assets/images/icons/icon-trade.svg" alt="icon"></i><span>Statement</span></a>
                </li>
